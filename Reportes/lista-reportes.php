...
<div class="container mt-5">
    ...
    <table class="table table-striped table-hover">
        <thead class="table-dark">
            <tr>
                <th>ID</th><th>Título</th><th>Tipo</th><th>Estado</th>
                <th>Fecha Reporte</th><th>Reportado Por</th><th>Acción</th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="#" class="btn btn-sm btn-info disabled">Ver Detalle (Próx. Iteración)</a>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
